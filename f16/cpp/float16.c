...
float f16_2_f32(float16_t v) {
      assert(sizeof(HALF_FLOAT) == 2);
      assert(sizeof(SINGLE_FLOAT) == 4);
      ...
      sf.R_s = hf.R_s;
      sf.R_e = hf.R_e - 15 + 127;
      sf.R_m = hf.R_m << (23-10);

      return sf.r;
}

float16_t f32_2_f16(float s) {
      assert(sizeof(HALF_FLOAT) == 2);
      assert(sizeof(SINGLE_FLOAT) == 4);
