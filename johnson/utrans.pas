...
procedure randomTransformation(var poly: CPoly);
...
begin
  ...
  begin
    ...
    for v2 in face do
    begin
      if (length(face) > 2) and faceMap.Find(mki4(v2, v1), iout) then
      begin
        flag.addFace(mki4(v1), mki4(faceMap.Data[iout]), mki4(nface));
