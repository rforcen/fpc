...
type
  ...
  type
    TGetCurrent =
    function(const Pos: _TPosition_): _TItem_ of object;
    TMoveNext =
    function(var Pos: _TPosition_): boolean of object;
  private
    fGetter: TGetCurrent;
    fMover: TMoveNext;
    fPos: _TPosition_;
  ...
  type
    PItem = ^_TItem_;
    TCompareItems =
    function(const A, B: _TItem_): integer of object;
    TItemToString =
    function(const Item: _TItem_): string of object;
    TProcessItem =
    procedure(var Item: _TItem_) of object;
  ...
  type
    THashKey =
    function(const Key: _TKey_): integer of object;
    TItemToString =
    function(const Item: _TItem_): string of object;
    TKeysEqual =
    function(const A, B: _TKey_): boolean of object;
    TKeyToString =
    function(const Key: _TKey_): string of object;
  ...
  public
    ...
    property MaxLoadFactor: double read fMaxLoadFactor;
  ...
  type
    TItemEquals =
    function(const A, B: _TItem_): boolean of object;
    TItemToString =
    function(const Item: _TItem_): string of object;
    THashItem =
    function(const Item: _TItem_): integer of object;
  ...
  type
    TCompareKeys =
    function(const A, B: _TKey_): integer of object;
    TItemToString =
    function(const Item: _TItem_): string of object;
    TKeyToString =
    function(const Key: _TKey_): string of object;
...
function TAbstractVector.getHigh: integer;
begin
  Result := fSize - 1;
end;
...
begin
  Result := (fHashMap = Cursor.fHashMap) and (fBucket = Cursor.fBucket) and
...
{--- TGenHashMap.Create ---}
constructor TGenHashMap.Create(InitialCapacity: integer; MaxLoadFact: double);
var
  Capacity: integer;
begin
  inherited Create;
...
{--- TGenHashMap.Create ---}
constructor TGenHashMap.Create(MaxLoadFact: double);
begin
...
function TGenHashMap.GetLoadFactor: double;
begin
...
{--- TGenHashSet.Create ---}
constructor TGenHashSet.Create(InitialCapacity: integer; LoadFact: double);
begin
...
{--- TGenHashSet.Create ---}
constructor TGenHashSet.Create(LoadFact: double);
begin
  Create(16, LoadFact);
end;
...
begin
  Result := (Cursor.Entry <> nil) and
    (Cursor.Entry = (Cursor.TreeMap as TGenTreeMap).GetFirstEntry);
end;
...
begin
  Result := (Cursor.Entry <> nil) and
    (Cursor.Entry = (Cursor.TreeMap as TGenTreeMap).GetLastEntry);
end;
